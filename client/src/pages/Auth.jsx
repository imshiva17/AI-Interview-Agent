    ...
    <div className='w-full min-h-screen bg-[#f3f3f3] flex items-center justify-center px-6 py-20 ' >
        ...
        className='w-full max-w-md p-8 rounded-3xl bg-white shadow-2xl border border-gray-200 ' >
            ...
            <h1 className='text-2xl md:text-3xl font-semibold text-center leading-snug mb-4 '>Continue with{"  "}
                <span className='bg-green-100 text-green-600 px-3 py-1 rounded-full inline-flex items-center gap-2'><IoSparkles size={16} />AI Smart Interview</span>
            </h1>
            ...
            <motion.button
            wwhileHover={{opacity:0.9, scale: 1.03 }}
